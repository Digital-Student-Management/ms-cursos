package sistemaEscolar.ms_cursos.exceptions;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidationErrors(MethodArgumentNotValidException ex) {
        ...
        // Extrae cada error de campo y su mensaje
    ...
    /**
     * Maneja ResponseStatusException lanzadas desde el servicio (404, 409, 503, etc.).
